...
If the user says they already have some parts, do not replace those parts. Build only the missing components around them, respecting compatibility and the remaining budget.
